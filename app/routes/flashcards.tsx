...
export async function loader() {
  ...
  const imagesDir = process.env.NODE_ENV === 'production' ? '/data/images' : './images'
...
export default function Flashcards() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      localStorage.setItem('flashcards-selected-topics', JSON.stringify(Array.from(selectedTopics)))
    }
  }, [selectedTopics])
  ...
  if (filteredFlashcards.length === 0) {
    return (
      <div className="h-full flex items-center justify-center">
        <Card className="p-8 text-center">
          <h2 className="text-2xl font-bold mb-4">No Images in Selected Categories</h2>
          <p className="text-muted-foreground">
  ...
  return (
    <div className="relative h-full touch-manipulation select-none">
            ...
            <CardContent>
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2">
                    <Checkbox
                      ...
                      onCheckedChange={(checked) => setAutoShowName(checked as boolean)}
                    />
                ...
                <p className="text-sm text-muted-foreground">
                  Cards shown: {usedIndices.length} of {filteredFlashcards.length}
                </p>
              </div>
            </CardContent>
          </Card>
      ...
      >
        <div className="w-full flex-1 flex items-center justify-center overflow-hidden" style={{ maxHeight: 'calc(100vh - 12rem)' }}>
          <img
